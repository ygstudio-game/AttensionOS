    ...
    <div className="min-h-screen bg-[#0A0C10] text-white font-sans selection:bg-[var(--neon-cyan)]/20 dot-grid relative overflow-hidden">
      ...
      <nav className="relative z-50 flex justify-between items-center px-8 py-5 max-w-7xl mx-auto">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-lg font-bold tracking-tight">Attention<span className="text-[#00E5FF]">OS</span></span>
        </div>
        <div className="hidden md:flex gap-8 text-sm font-medium text-white/40">
          <a href="#features" className="hover:text-[#00E5FF] transition-colors duration-300">Features</a>
          <a href="#privacy" className="hover:text-[#00E5FF] transition-colors duration-300">Privacy</a>
          <a href="#about" className="hover:text-[#00E5FF] transition-colors duration-300">About</a>
        </div>
        <Link
          href="/focuslens"
